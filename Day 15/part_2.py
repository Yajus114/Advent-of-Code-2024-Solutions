...
def __move_robot(grid, instructions, start):
    ...
    while len(instructions) != 0:
        ...
        if grid[next_position] == ".":
            ...
            next_item_position = (
                next_position[0] + dxdy[0],
                next_position[1] + dxdy[1],
            )
...
def __move_robot_in_second_warehouse(grid, instructions, start):
    ...
    while len(instructions) != 0:
        ...
        if grid[next_position] == ".":
            ...
            positions = []
            if (grid[next_position] == "[" or grid[next_position] == "]") and (
                movement == "^" or movement == "v"
            ):
            ...
            while len(positions) != 0:
                ...
                while True:
                    if grid[pp] == ".":
                        ...
                        if (
                            grid[(second_half[0] + dxdy[0], second_half[1] + dxdy[1])]
                            == "."
                        ):
                            space_available = True
                            top_points.add((pp[0] + (-dxdy[0]), pp[1] + (-dxdy[1])))
                        ...
                        if (
                            ...
                            == "["
                            or grid[
                                (second_half[0] + dxdy[0], second_half[1] + dxdy[1])
                            ]
                            == "]"
                        ):
